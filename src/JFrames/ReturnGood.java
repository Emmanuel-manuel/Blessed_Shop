            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        Logger.getLogger(ReturnGood.class.getName()).log(Level.SEVERE, null, ex);
                    }
...
//        parentPanel.repaint();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReturnGood.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReturnGood().setVisible(true);
            }
        });
    }
