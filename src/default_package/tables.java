...
//            st.executeUpdate("create table products (id int(11) AUTO_INCREMENT PRIMARY KEY,product_name varchar(200),b_price int(11),s_price int(11),profit int(11),perc_profit DOUBLE, perc_commission DOUBLE)");
